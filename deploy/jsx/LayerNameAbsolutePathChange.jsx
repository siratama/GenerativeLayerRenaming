...
var common_LayerNameAbsolultePathChangeInitialErrorEvent = $hxClasses["common.LayerNameAbsolultePathChangeInitialErrorEvent"] = { __ename__ : ["common","LayerNameAbsolultePathChangeInitialErrorEvent"], __constructs__ : ["NONE","ERROR"] };
common_LayerNameAbsolultePathChangeInitialErrorEvent.NONE = ["NONE",0];
common_LayerNameAbsolultePathChangeInitialErrorEvent.NONE.toString = $estr;
common_LayerNameAbsolultePathChangeInitialErrorEvent.NONE.__enum__ = common_LayerNameAbsolultePathChangeInitialErrorEvent;
common_LayerNameAbsolultePathChangeInitialErrorEvent.ERROR = function(error) { var $x = ["ERROR",1,error]; $x.__enum__ = common_LayerNameAbsolultePathChangeInitialErrorEvent; $x.toString = $estr; return $x; };
...
var LayerNameAbsolutePathChange = $hxClasses["LayerNameAbsolutePathChange"] = function() {
	this.application = psd_Lib.app;
};
LayerNameAbsolutePathChange.__name__ = ["LayerNameAbsolutePathChange"];
LayerNameAbsolutePathChange.main = function() {
};
LayerNameAbsolutePathChange.prototype = {
	getInitialErrorEvent: function() {
		var error;
		if(this.application.documents.length == 0) error = "Unopened document."; else error = null;
		var event;
		if(error == null) event = common_LayerNameAbsolultePathChangeInitialErrorEvent.NONE; else event = common_LayerNameAbsolultePathChangeInitialErrorEvent.ERROR(error);
	...
	,execute: function() {
		...
		var selectedLayerSet = jsx_util_LayerUtil.getSlectedLayerSet(this.activeDocument);
		var _g = 0;
		while(_g < selectedLayerSet.length) {
			var selectedLayer = selectedLayerSet[_g];
			++_g;
			var path = layerStructure.getPath(selectedLayer);
			selectedLayer.name = path + ".png";
		}
	}
	,__class__: LayerNameAbsolutePathChange
};
var jsx__$LayerNameAbsolutePathChange_LayerNameAbsolutePathChangeJSXRunner = $hxClasses["jsx._LayerNameAbsolutePathChange.LayerNameAbsolutePathChangeJSXRunner"] = function() { };
jsx__$LayerNameAbsolutePathChange_LayerNameAbsolutePathChangeJSXRunner.__name__ = ["jsx","_LayerNameAbsolutePathChange","LayerNameAbsolutePathChangeJSXRunner"];
jsx__$LayerNameAbsolutePathChange_LayerNameAbsolutePathChangeJSXRunner.execute = function() {
	var frameAnimationExport = new LayerNameAbsolutePathChange();
...
jsx_parser_layer_LayerStructure.prototype = {
	...
	,getPath: function(layer) {
		var _g = 0;
		var _g1 = this.layerPropertySet;
		while(_g < _g1.length) {
			var layerProperty = _g1[_g];
			++_g;
			if(layerProperty.layer == layer) return layerProperty.path;
		}
		return null;
	}
...
LayerNameAbsolutePathChange.main();
